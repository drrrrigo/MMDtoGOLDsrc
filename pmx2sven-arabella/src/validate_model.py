...
def main() -> int:
    ...
    preview_paths = [project / "build/previews" / name for name in ("base_front.png", "base_side.png", "base_perspective.png")]
    ...
    checks = {
        ...
        "working_geometry_not_decimated": work_vertices == 67729 and work_triangles == 81586,
    ...
    output = project / "build/reports/phase2_validation.json"
